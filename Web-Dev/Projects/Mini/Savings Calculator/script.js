...
calculateBtn.addEventListener("click", () => {
  ...
  if (isNaN(goalAmount || currentSavings || monthlyContribution)) {
  ...
  const remainingAmt = goalAmount - currentSavings;
  const monthsToGoal = Math.ceil(remainingAmt / monthlyContribution);
  ...
  setTimeout(() => {
    ...
    `;
      ...
      result.innerHTML = `Keep nurturing your savings! Youll Reach your goil in ${monthsToGoal} months.`;
    }
    result.classList.add("show");
  }, 100);
});
